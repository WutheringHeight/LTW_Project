<%@ taglib prefix="c" uri="http://xmlns.jakarta.ee/jsp/jstl/core" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>Sign Up</title>
    <link rel="stylesheet" href="<c:url value='/Login&SignUp/style.css'/>">
</head>
<body>
    ...
    <section style="display: flex; flex-direction:column; justify-content: center; align-items: flex-end; min-width: 100vw; min-height: 90vh;">
        ...
        <h3>Sign up</h3>
        <form action="/signup" style="display: flex; flex-direction:column; justify-content: center; align-items: center;">
