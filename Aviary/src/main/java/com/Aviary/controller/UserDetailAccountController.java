...
public class UserDetailAccountController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        UserDetail details = UserDetailDao.getUserDetail(userID);
        request.setAttribute("userDetail", details);
