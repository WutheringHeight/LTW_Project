        ...
        <section class="userdetails-content">
            ...
            <section class="bookmark-box">
                <c:forEach items="${bookmarks}" var="bookmark">
                    <a href="../productDetail/product.html">
                    <div class="bookmark">
                        <img src="bookmark.thumbnail">
                        <section class="bookmark-desp">
                            <h4>${bookmark.name}</h4>
                            ...
                            %>
                            <p> <%= message %> </p>
                            <p>${bookmark.stock} Available</p>
                        </section>
                        <button class="bookmark-buttons">               
                            <img src="res/trashcan.png" class="mid-icon trashcan">
                        </button>
                    </div>
                    </a>
                </c:forEach>
